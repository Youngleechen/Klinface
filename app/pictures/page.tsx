...
export default function ScreenshotsPage() {
  ...
  return (
    <div className="w-full px-4 md:px-8 lg:px-16 xl:px-24 py-10">
      ...
      {/* Header with new title + slick button */}
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-10">
        ...
        <Link href="/testimonials">
          <button className="group relative inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:-translate-y-0.5 active:scale-95">
